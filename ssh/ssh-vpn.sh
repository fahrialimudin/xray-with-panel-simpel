...
curl -sS https://raw.githubusercontent.com/fahrialimudin/xray-with-panel-simpel/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/fahrialimudin/xray-with-panel-simpel/main/ssh/nginx.conf"
...
# ============================================================
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/fahrialimudin/xray-with-panel-simpel/main/ssh/newudpgw"
...
GHBASE="https://raw.githubusercontent.com/fahrialimudin/xray-with-panel-simpel/main"
